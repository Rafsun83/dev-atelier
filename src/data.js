  ...
  posts: [
    {
      ...
      excerpt: "JavaScript frees memory automatically, but knowing how it works helps you avoid accidental leaks. Mark-and-Sweep explained simply — no engine internals required.",
    ...
    },
    {
      ...
      excerpt: "Variables, functions, and objects all live somewhere when JavaScript runs. Understanding the Stack, the Heap, and the Call Stack gives you a sharper mental model for debugging and performance.",
    ...
    },
    {
      ...
      excerpt: "From memoization to web workers to lazy loading, a practical overview of 10 techniques that can take your JavaScript from sluggish to seriously fast.",
    ...
    },
    {
      ...
      read:    "10 MIN",
      tag:     "JAVASCRIPT",
      title:   "\"Why Is My Variable Running Everywhere?\" — Deep-Dive Into JavaScript Scope",
      excerpt: "var, let, and const behave differently across blocks and functions because of how scope works. The full deep-dive — from global scope to the scope chain — that finally makes it click.",
      ...
      thumb:   "https://cdn-images-1.medium.com/max/1024/1*B7H5zG6uYfOF5iGJfc4Bxw.jpeg",
    },
    {
      date:    "2025 · 11 · 04",
      read:    "8 MIN",
      tag:     "JAVASCRIPT",
      title:   "Mastering the JavaScript reduce() Method — Step-by-Step with Examples",
      excerpt: "If you've used map() and filter(), you've met reduce()'s cousins. But reduce() itself can replace them both — from summing numbers to building objects and running async tasks in sequence.",
      link:    "https://medium.com/@rafsun7774/mastering-the-javascript-reduce-method-step-by-step-with-examples-ba8e4e6b8ea1",
      thumb:   "https://cdn-images-1.medium.com/max/494/1*zb5SpvZ2ZHEaxgjHKUDcQw.png",
    },
    {
      date:    "2025 · 07 · 15",
      read:    "4 MIN",
      ...
      excerpt: "JSX looks like HTML but has the full power of JavaScript. Here are the best practices that keep your React components clean, readable, and maintainable.",
      link:    "https://medium.com/@rafsun7774/understanding-jsx-syntax-and-best-practices-f6dbb73d9cb2",
      thumb:   "https://cdn-images-1.medium.com/max/725/1*OgOVcZa6WPRYqClLNEMFnA.png",
    },
  ],
};
